...
//替换成你的AK
        final String accessKeyId = "LTAI4FkCMSb1Aik5tgViAPRT";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "XkJGvzX9UHaEpft02cboSH7crDfXdJ";//你的accessKeySecret，参考本文档步骤2
...
//请求成功
    ...
    public static String sendCode(String phones, String code) {
        ...
        String signName = "小黄人";  //签名
        String templateCode = "SMS_187241645";  //模板
