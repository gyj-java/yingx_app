...
public class AliyunOssUtil {
   ...
   * */
    ...
    public static void main(String[] args) {
        String bucket="yingx-gyj";   //存储空间名
        String fileName="图片.jpg";  //指定上传文件名  可以指定上传目录
        String localFilePath="G:\\壁纸\\104340-1562985820e760.jpg";  //指定本地文件路径
//
//        //调用测试方法
//        uploadFile(bucket,fileName,localFilePath);
        delete("1585916750151-泰山之旅.mp4");
    }
}
